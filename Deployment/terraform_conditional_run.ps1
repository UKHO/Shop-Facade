...
#sWrite-output "Executing terraform apply"
...
Write-Host "##vso[task.setvariable variable=ShopFacadeConfiguration.BaseUrl]$($terraformOutput.shop_facade_web_app_public_url.value)"
