...
namespace UKHO.ShopFacade.API.UnitTests.Services
{
    ...
    public class UpnServiceTests
    {
        ...
        [Test]
        public async Task WhenUpnDetailsAreValid_ThenGetUpnDetailsReturns200SuccessResponse()
        {
        ...
        [Test]
        public async Task WhenLicenceIsNotFound_ThenGetUpnDetailsReturns404NotFoundResponse()
        {
