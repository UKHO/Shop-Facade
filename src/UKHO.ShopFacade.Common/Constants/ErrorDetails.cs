...
namespace UKHO.ShopFacade.Common.Constants
{
    ...
    public static class ErrorDetails
    {
        ...
        public const string SalesCatalogueDataRequestInternalServerErrorMessage = "Failed to connect Sales Catalogue Service | StatusCode: {StatusCode} | Retry limit exceeded for request to {RequestUri}.";
        ...
        public const string S100PermitServiceInternalServerErrorMessage = "Failed to connect Permit Service | StatusCode: {StatusCode} | Retry limit exceeded for request to {RequestUri}.";
