...
namespace UKHO.ShopFacade.Common.Constants
{
    ...
    public static class ErrorDetails
    {
        ...
        public const string SalesCatalogueDataRequestInternalServerErrorMessage = "Error occurred while processing Sales Catalogue Service request | StatusCode: {StatusCode} | Uri: {RequestUri}.";
        ...
        public const string S100PermitServiceInternalServerErrorMessage = "Error occurred while processing Permit Service request | StatusCode: {StatusCode} | Uri: {RequestUri}.";
